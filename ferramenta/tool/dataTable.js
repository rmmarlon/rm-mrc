...
(function($, window, document, undefined) {
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input type="text" class="fonte13" />') :
			  sSearchStr==="" ? '<input type="text" class="fonte13" />' : sSearchStr+' <input type="text" class="fonte13" />';
	...
	DataTable.defaults = {
		...
		"bInfo": true,
		"bJQueryUI": true,
		//REMOVE CABEÇALHO SUPERIOR COM O FILTRO
		"bLengthChange": true,
		"bPaginate": true,
		"bProcessing": false,
		"bRetrieve": false,
		...
		"oLanguage": {
			...
			"sEmptyTable": "Não foi encontrato registro.",
			"sInfo": "Mostrando _START_ até _END_ de _TOTAL_ registros",
			"sInfoEmpty": "Showing 0 to 0 of 0 entries",
			"sInfoFiltered": "(Filtrado  a partir  _MAX_ registros totais)",
			"sInfoPostFix": "",
			"sInfoThousands": ",",
			...
			"sSearch": "Pesquisar:",
			"sUrl": "",
			"sZeroRecords": "Não foi encontrato registro."
		},
	...
	$.extend( DataTable.ext.oSort, {
		...
		"date-pre": function ( a )
		{
			var x = Date.parse( a.split("/")[2].toString() + '-' + a.split("/")[1].toString() + '-' + a.split("/")[0].toString() );
			//alert(x);
			if ( isNaN(x) || x==="" )
			{
